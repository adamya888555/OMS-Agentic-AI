...
class OrderProcessor:
    ...
    def __init__(self, storage: OrderStorage):
        ...
        self.prompt_dir = os.path.join(project_root, "AIRTEL OMS", "prompts")
    ...
    def parsing_input(self, user_input: str , role: str) -> Dict:
        ...
        parser_prompt_template = self.load_prompt("parser_input.txt")
        parser_prompt = self.render_prompt(parser_prompt_template, user_input=user_input)
